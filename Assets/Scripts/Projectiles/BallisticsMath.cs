...
namespace TowerDefense.Projectiles
{
    ...
    public static class BallisticsMath
    {
            ...
            float fireAngle, float gravity)
        {
            ...
            float b =
                Mathf.Sqrt((launchSpeed * launchSpeed * (sinFireAngle * sinFireAngle)) + (2 * gravity * relativeY)) /
                gravity;
        ...
        public static Vector3 CalculateBallisticLeadingTargetPointWithSpeed(Vector3 firePosition,
            ...
            int precision = 2)
        {
            ...
            {
                float fireAngle =
                    CalculateBallisticFireAngle(firePosition, testPosition, launchSpeed, arcHeight, gravity);

                float impactTime =
                    CalculateBallisticFlightTime(firePosition, testPosition, launchSpeed, fireAngle, gravity);
        ...
        {
            return CalculateBallisticLeadingTargetPointWithSpeed(firePosition, targetPosition, targetVelocity,
                launchSpeed,
            ...
            int precision = 2)
        {
            ...
            {
                float launchSpeed =
                    CalculateBallisticFireVectorFromAngle(firePosition, testPosition, launchAngle, gravity)
                        .magnitude;

                float impactTime =
                    CalculateBallisticFlightTime(firePosition, testPosition, launchSpeed, launchAngle, gravity);
