...
public class TowerController : MonoBehaviour
{
    ...
    private Events.TowerSelledEvent _towerSelled;
    ...
    private void Start()
    {
        if (_towerSelled == null)
            _towerSelled = new Events.TowerSelledEvent();
        
        _towerSelled.AddListener(GameManager.Instance.OnTowerSelled);
